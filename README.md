...
| `apply_patch` | Standalone local CLI built by both the Rust host crate and C++ daemon build. It reads a Codex-style patch from standard input. `--help` prints built-in usage, while `--help-file PATH` prints the supplied help file. |
