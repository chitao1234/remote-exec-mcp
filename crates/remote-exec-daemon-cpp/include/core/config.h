...
struct DaemonConfig {
    ...
    unsigned long reverse_min_idle_connections = DEFAULT_REVERSE_MIN_IDLE_CONNECTIONS;
    unsigned long reverse_max_connections = DEFAULT_REVERSE_MAX_CONNECTIONS;
    unsigned long reverse_reconnect_ms = DEFAULT_REVERSE_RECONNECT_MS;
