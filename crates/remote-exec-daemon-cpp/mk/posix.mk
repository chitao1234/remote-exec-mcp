...
POSIX_FEATURE_CPPFLAGS ?= $(shell HOST_CXX="$(HOST_CXX)" PROBE_CPPFLAGS="$(COMMON_CPPFLAGS)" PROBE_CXXFLAGS="$(PROD_CXXFLAGS) $(POSIX_PTHREAD_FLAGS)" sh "$(POSIX_FEATURE_CPPFLAGS_SCRIPT)")
...
POSIX_SOCKET_LDLIBS ?= $(shell HOST_CXX="$(HOST_CXX)" PROBE_CPPFLAGS="$(COMMON_CPPFLAGS) $(POSIX_FEATURE_CPPFLAGS)" PROBE_CXXFLAGS="$(PROD_CXXFLAGS) $(POSIX_PTHREAD_FLAGS)" PROBE_LDFLAGS="$(HOST_PROD_LDFLAGS)" PROBE_LDLIBS="$(POSIX_BASE_LDLIBS)" sh "$(POSIX_SOCKET_LDLIBS_SCRIPT)")
