...
POSIX_TLS := $(TLS)
ifeq ($(TLS),auto)
POSIX_TLS := $(shell HOST_CXX="$(HOST_CXX)" PROBE_CPPFLAGS="$(COMMON_CPPFLAGS) $(OPENSSL_CANDIDATE_CPPFLAGS)" PROBE_CXXFLAGS="$(PROD_CXXFLAGS) $(POSIX_PTHREAD_FLAGS)" PROBE_LDFLAGS="$(HOST_PROD_LDFLAGS)" PROBE_LDLIBS="$(POSIX_BASE_LDLIBS) $(OPENSSL_CANDIDATE_LDLIBS)" sh "$(POSIX_OPENSSL_PROBE_SCRIPT)" && printf openssl || printf off)
endif
ifeq ($(POSIX_TLS),openssl)
...
POSIX_FEATURE_CPPFLAGS ?= $(shell HOST_CXX="$(HOST_CXX)" PROBE_CPPFLAGS="$(COMMON_CPPFLAGS) $(POSIX_OPENSSL_CPPFLAGS)" PROBE_CXXFLAGS="$(PROD_CXXFLAGS) $(POSIX_PTHREAD_FLAGS)" sh "$(POSIX_FEATURE_CPPFLAGS_SCRIPT)")
...
POSIX_SOCKET_LDLIBS ?= $(shell HOST_CXX="$(HOST_CXX)" PROBE_CPPFLAGS="$(COMMON_CPPFLAGS) $(POSIX_OPENSSL_CPPFLAGS) $(POSIX_FEATURE_CPPFLAGS)" PROBE_CXXFLAGS="$(PROD_CXXFLAGS) $(POSIX_PTHREAD_FLAGS)" PROBE_LDFLAGS="$(HOST_PROD_LDFLAGS)" PROBE_LDLIBS="$(POSIX_BASE_LDLIBS) $(POSIX_OPENSSL_LDLIBS)" sh "$(POSIX_SOCKET_LDLIBS_SCRIPT)")
