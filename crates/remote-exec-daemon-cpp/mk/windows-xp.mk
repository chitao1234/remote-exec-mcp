...
WINDOWS_XP_PROD_CPPFLAGS := $(WINDOWS_COMMON_CPPFLAGS) $(WINDOWS_XP_VERSION_CPPFLAGS)
WINDOWS_XP_TEST_CPPFLAGS := $(WINDOWS_COMMON_CPPFLAGS) $(WINDOWS_XP_VERSION_CPPFLAGS) -DREMOTE_EXEC_CPP_TESTING
...
$(WINDOWS_XP_TARGET): $(WINDOWS_XP_OBJS)
	mkdir -p $(dir $@)
	$(WINDOWS_CXX) $(WINDOWS_PROD_CXXFLAGS) $(WINDOWS_LDFLAGS) -o $@ $^ $(WINDOWS_XP_LDLIBS)

$(WINDOWS_XP_PROD_OBJ_DIR)/%.o: $(MAKEFILE_DIR)%.cpp
	mkdir -p $(dir $@)
	$(WINDOWS_CXX) $(WINDOWS_XP_PROD_CPPFLAGS) $(WINDOWS_PROD_CXXFLAGS) $(DEPFLAGS) -c -o $@ $<
