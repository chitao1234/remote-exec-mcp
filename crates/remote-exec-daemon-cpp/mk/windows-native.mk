...
WINDOWS_NATIVE_PROD_CPPFLAGS := $(COMMON_CPPFLAGS) -DWIN32_LEAN_AND_MEAN -DUNICODE -D_UNICODE
WINDOWS_NATIVE_PROD_CXXFLAGS := $(PROD_CXXFLAGS)
WINDOWS_NATIVE_TEST_CPPFLAGS := $(COMMON_CPPFLAGS) -DWIN32_LEAN_AND_MEAN -DUNICODE -D_UNICODE -DREMOTE_EXEC_CPP_TESTING
...
WINDOWS_NATIVE_PROCESS_TEST_TARGETS := \
	$(WINDOWS_NATIVE_SESSION_STORE) \
	$(WINDOWS_NATIVE_SERVER_STREAMING)
...
$(eval $(call run_test,test-windows-native-server-streaming,$(WINDOWS_NATIVE_SERVER_STREAMING)))
$(eval $(call link_windows_native_test,$(WINDOWS_NATIVE_SERVER_STREAMING),$(WINDOWS_NATIVE_SERVER_STREAMING_OBJS)))
