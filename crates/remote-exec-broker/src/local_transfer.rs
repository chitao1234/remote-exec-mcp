...
use remote_exec_proto::rpc::{TransferImportRequest, TransferImportResponse, TransferSourceType};
...
pub async fn export_path_to_archive(
    ...
    remote_exec_daemon::transfer::archive::export_path_to_file(path, archive_path, sandbox).await
}
